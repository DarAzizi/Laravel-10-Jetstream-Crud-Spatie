        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <x-nav-dropdown title="Apps" align="right" width="48">
                        ...
                        @endcan
                        @can('view-any', App\Models\Graduation::class)
                        <x-dropdown-link href="{{ route('graduations.index') }}">
                        Graduations
                        </x-dropdown-link>
                        @endcan
                ...
                <x-nav-dropdown title="Books" align="right" width="48">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link href="{{ route('dashboard') }}" :active="request()->routeIs('dashboard')">
                ...
                @endcan
                @can('view-any', App\Models\University::class)
                <x-responsive-nav-link href="{{ route('universities.index') }}">
                Universities
                </x-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\Graduation::class)
                <x-responsive-nav-link href="{{ route('graduations.index') }}">
                Graduations
                </x-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\Certificate::class)
